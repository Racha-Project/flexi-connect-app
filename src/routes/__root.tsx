...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "LachaFit Connect is a modern fitness platform connecting clients with personal trainers." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Fitder" },
      { name: "description", content: "LachaFit Connect is a modern fitness platform connecting clients with personal trainers." },
      { name: "twitter:description", content: "LachaFit Connect is a modern fitness platform connecting clients with personal trainers." },
